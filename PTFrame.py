...
class PTFrame (wx.Frame):
    ...
    def addModuleList(self):
        ...
        grid = wx.GridSizer(len(self.moduleList)+1, 5, 10, 10)
        ...
        for module in self.moduleList:
            ...
            grid.Add(operateBtn, 0, wx.EXPAND)

        hbx2 = wx.BoxSizer(wx.HORIZONTAL)
        hbx2.Add((10,0))
        hbx2.Add(grid, flag=wx.ALIGN_CENTER)
        hbx2.Add((10,0))
    ...
    def OnAddModuleCallback(self, result):
        if result == True:
